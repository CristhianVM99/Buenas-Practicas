...
class MapaController extends Controller
{
    ...
    public function getproyectos(){    
        ...
        foreach($Proyectos as $proy){
            if($proy->tipo == 1){
                $objeto = ['proyecto'=>$proy,'ciudad'=>$proy->ciudad,'lat'=>$proy->latitud,'lng'=>$proy->longitud,'type'=>'idea inovadora'];
                array_push($listaProyectos,$objeto);
            }else{
                $objeto = ['proyecto'=>$proy,'ciudad'=>$proy->ciudad,'lat'=>$proy->latitud,'lng'=>$proy->longitud,'type'=>'buena practica'];
                array_push($listaProyectos,$objeto);
            }
        }
        $extras = [            
