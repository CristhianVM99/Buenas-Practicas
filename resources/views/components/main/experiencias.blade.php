...
<style>
    ...
    .height-100, .owl-stage-outer, .owl-stage , .owl-item{
        height: 100%;
    }
        ...
        <div class="row">
            <div class="col-lg-3 col-sm-4">
                ...
                <div class="widget widget_categories topmargin_50">
                    <ul class="greylinks color4 menu_categorias">
                        @foreach ($sectores as $cat)
                        <li>
                            <a href="javascript:void(0)" onclick="previewVideos(event, {{ $cat->id }})">{{ $cat->name }}</a>
                        </li>
                        @endforeach
                    </ul>
                </div>
            ...
            <div class="col-lg-9 col-sm-8">
                ...
                <div class="owl-carousel hidden" data-sector="{{$sector->id}}" data-nav="true" data-responsive-sm="2" data-responsive-lg="3">
